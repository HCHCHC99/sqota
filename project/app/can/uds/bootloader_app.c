 ...
 * @brief   UDS shared state + Phase 3 deferred ACK for APP-only
 */
...
static uint32_t read_word(uint32_t addr) {
    uint32_t v; EFM_ReadByte(addr, (uint8_t*)&v, 4); return v;
}
